...
// デバッグ用描画
    ...
    public void onClickNumber(int num) {
        ...
        if(mActivity instanceof CalculateViewListener){
          CalculateViewListener listener = (CalculateViewListener)mActivity;
    ...
    public void onClickShift(boolean flg) {

        if(mActivity instanceof CalculateViewListener){
            CalculateViewListener listener = (CalculateViewListener)mActivity;
            listener.onSelectShift(flg);
        }
    }
